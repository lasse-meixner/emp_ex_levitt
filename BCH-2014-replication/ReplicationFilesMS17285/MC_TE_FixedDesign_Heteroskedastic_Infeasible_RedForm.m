...
%
function [ ALL_StdErr, ALL_ALPHA ] = MC_TE_FixedDesign_Heteroskedastic_Infeasible_RedForm ( NUM_SIM, rho, alpha0, R21, R22, design, p, n )
...
%         
        ...
        NEWY = Y - b_int - X(:,3:end)*beta0second;
        [NEWpostORACLE, ~] = regress(NEWY,X(:,2));
        [ se_hetNEWORACLE ] = Heteroskedastic_se ( NEWY, X(:,2), [], NEWpostORACLE );
...
%         [ se_hetNEWORACLE ] = Heteroskedastic_se ( Y, X(:,2), X(:,logical([ 1 ; 0 ; ORACLEsecond ])), NEWpostORACLE(2) );
        ...
        NEWX = X(:,2) - b_int - X(:,3:end)*beta0first;
        [NEWpostORACLEds, ~] = regress(NEWY,NEWX);
        [ se_hetNEWORACLEds ] = Heteroskedastic_se ( NEWY, NEWX, [] , NEWpostORACLEds );
...
%         [ alpha_ss, se_ss ] = MC_TE_LassoHeteroskedastic_SplitSample ( Y, X, conf_lvl, k );
        ...
        %%%% INFERENCE SUMMARY %%%%%%%%%%%%%%%%%%%
        ALL_StdErr = [ALL_StdErr ; 1 ... %se_hetLASSO ...
                                   1 ... %se_het2STEP ... 
                                   1 ... %se_hetSQLASSO ...
                                   1 ... %se_het2STEPsq ...
                                   1 ... %se_hetAGG ...
                                   ...
                                   1 ... %se_hetNEWSECOND_11 ...
                                   se_hetNEWORACLE ... 
                                   se_hetNEWORACLEds ...
                                   1 ... %se_ss
                                   ]; %#ok<AGROW>
        ALL_ALPHA = [ ALL_ALPHA ; 0 ... %betaLASSO(2) ...
                                  0 ... %beta2STEP(2) ...
                                  0 ... %betaSQLASSO(2) ...
                                  0 ... %beta2STEPsq(2)...  
                                  0 ... %AGGpost(2) ...
